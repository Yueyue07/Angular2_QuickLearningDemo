...
var ProductFilterPipe = (function () {
    ...
    ProductFilterPipe.prototype.transform = function (productList, inputString) {
        var filterString = inputString[0] ? inputString[0].toLowerCase() : null;
        return filterString ? productList.filter(function (item) {
